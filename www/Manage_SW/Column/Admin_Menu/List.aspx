<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Manage_SW_Column_Admin_Menu_List" %>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                 <%#GetHref(Eval("ColumnID").ToString(),Eval("ParentID").ToString(),Eval("ID").ToString())%>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
