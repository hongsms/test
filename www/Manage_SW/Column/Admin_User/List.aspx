<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Manage_SW_Column_Admin_User_List" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <a href="Edit.aspx?<%#StringHelper.UpUrlParameter("ID", Eval("ID",""))%>"><%#Eval("UserName")%></a>
                                </td>
                                <td>
                                    <%#Eval("RealName")%>
                                </td>
                                <td>
                                    <%#OperateHelper.GetRoleName(Eval("RoleID"))%>
                                </td>
                                <td>
                                    <%#Eval("AddDate")%>
                                </td>
                                <td>
                                    <%#(Eval("State").ToString() == "1") ? "正常" : "锁定"%>
                                </td>
                                <td align="center">
