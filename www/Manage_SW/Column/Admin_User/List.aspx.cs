...
public partial class Manage_SW_Column_Admin_User_List : AdminRoot
{
    ...
    private void Bind()
    {
        string strWhere = " 1=1 ";
        int NumPerPage = 10;
        rptList.DataSource = BAdmin_User.GetListByPage(strWhere, " AddDate desc ", page, NumPerPage);
        rptList.DataBind();
        int TotleNum = BAdmin_User.GetRecordCount(strWhere);
    ...
    protected void btnDelAll_Click(object sender, EventArgs e)
    {
        ...
        if (strID == "10001")
        {
            MessageBox.Show(this, "对不起，该用户不能删除！");
        }
        ...
        {
            BAdmin_User.DeleteList((strID + ",").Replace("10001,", "").Trim(','));
