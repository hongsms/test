<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copyweb.aspx.cs" Inherits="Manage_SW_Column_Admin_WebSite_Copyweb" %>
        ...
        <div class="content-edit">
            ...
            <div class="nav-tabs-content active">
                ...
                <dl>
                    <dt>生成站点</dt>
                    <dd>
                        <asp:DropDownList ID="ddlSite" runat="server" CssClass="selectpicker form-control">
                        </asp:DropDownList>
                    </dd>
                </dl>
            </div>
