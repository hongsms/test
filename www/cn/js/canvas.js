(function(){
    ...
    var drawXAxis = function(xAxis){
        ...
        for(var i=0; i<len; i++){
            ...
            ctx.fillStyle = "#333";
            //字体居中
            ctx.fillText(xAxis[i],x_scale+(i+0.5)*stepWidth-xAxis[i].length*14/2+16,canvas.height-y_scale + 12);
    ...
    var drawYaxis = function(maxValue,step){
        ...
        for(var i=1; i<=step; i++){
            ctx.font = "normal normal 12px 微软雅黑";
            //字体居中
            ctx.fillText(maxValue/step*i,x_scale-32,canvas.height-y_scale-stepHeight*i+7);
